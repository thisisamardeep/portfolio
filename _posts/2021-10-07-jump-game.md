...
We will solve all the  problem [Jump Game](https://leetcode.com/problems/jump-game/description/)  using 3 different ways .
...
First let us under stand the problem.We have a vector 
